...
\subsection{Overview of Policies towards Opioid Users} %TODO: Reference
...
\begin{figure}[H]
	...
	\begin{minipage}[b]{0.48\textwidth} %所有minipage宽度之和要小于1，否则会自动变成竖排
		\centering %图片局部居中
		\includegraphics[scale=0.6]{./figures/13.png} %此时的图片宽度比例是相对于这个minipage的，不是全局
		% \caption{}
	\end{minipage}
	\begin{minipage}[b]{0.48\textwidth} %所有minipage宽度之和要小于1，否则会自动变成竖排
		\centering %图片局部居中
		\includegraphics[scale=0.6]{./figures/14.png}%此时的图片宽度比例是相对于这个minipage的，不是全局
		% \caption{}
	\end{minipage}
